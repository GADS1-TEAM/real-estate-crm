...
namespace OperationsBff.Api.PlatformConfigService;

/// <summary>
/// Cliente HTTP tipado hacia platform-config-service, con token relay (D6): reenvía el access
...
/// </summary>
public sealed class PlatformConfigServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
