...
/// <summary>
/// Cliente HTTP tipado hacia access-service, con token relay (D6): reenvía el access token de
/// la sesión cookie del usuario como Bearer. Sin client credentials propias del BFF (D6: "sin
/// client credentials internas en la POC").
/// </summary>
public sealed class AccessServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
