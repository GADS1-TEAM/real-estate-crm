...
namespace OperationsBff.Api.MatchingService;

/// <summary>
/// Cliente HTTP tipado hacia matching-service, con token relay (D6).
/// </summary>
public sealed class MatchingServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
