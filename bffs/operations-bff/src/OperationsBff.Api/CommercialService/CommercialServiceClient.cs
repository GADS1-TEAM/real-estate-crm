...
namespace OperationsBff.Api.CommercialService;

/// <summary>
/// Cliente HTTP tipado hacia commercial-service, con token relay (D6).
/// </summary>
public sealed class CommercialServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
