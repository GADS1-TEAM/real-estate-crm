...
namespace OperationsBff.Api.DemandService;

/// <summary>
/// Cliente HTTP tipado hacia demand-service, con token relay (D6).
/// </summary>
public sealed class DemandServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
