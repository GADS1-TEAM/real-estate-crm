...
namespace OperationsBff.Api.AnalyticsService;

/// <summary>
/// Cliente HTTP tipado hacia analytics-service, con token relay (D6).
/// </summary>
public sealed class AnalyticsServiceClient(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
{
