# W7-POR-02 — Contrato, canon, pagos y mantenimiento

- **Ola:** 7 — Expansión opcional y backoffice avanzado
- **Estado:** `TODO`
- **Dependencias:** `W5-RNT-03`, `W7-MNT-01`
- **UCs:** `POR-005`, `POR-006`, `POR-007`, `POR-008`
- **Owner:** `rental-service`, `maintenance-service`.
...
## Resultado
Contrato, canon, pagos y mantenimiento.
