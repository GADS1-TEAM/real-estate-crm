# W7-PLT-02 — Pilotos y ExtensionSchema versionado

- **Ola:** 7 — Expansión opcional y backoffice avanzado
- **Estado:** `TODO`
- **Dependencias:** `W7-PLT-01`
- **UCs:** `PLT-005`, `PLT-007`, `PLT-008`
- **Owner:** `platform-config-service`, `access-service`.
...
## Resultado
Pilotos y ExtensionSchema versionado.
