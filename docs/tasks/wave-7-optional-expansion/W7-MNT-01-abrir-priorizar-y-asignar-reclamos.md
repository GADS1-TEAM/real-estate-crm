# W7-MNT-01 — Abrir, priorizar y asignar reclamos

- **Ola:** 7 — Expansión opcional y backoffice avanzado
- **Estado:** `TODO`
- **Dependencias:** `W5-RNT-01`
- **UCs:** `MNT-001`, `MNT-002`, `MNT-003`
- **Owner:** `maintenance-service`, `automation-ai-service`.
...
## Resultado
Abrir, priorizar y asignar reclamos.
