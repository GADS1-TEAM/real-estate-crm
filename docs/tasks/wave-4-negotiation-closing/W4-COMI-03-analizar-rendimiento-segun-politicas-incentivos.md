# W4-COMI-03 — Analizar rendimiento según políticas/incentivos

**Ola:** 4 — Negociación y cierre  
**Estado inicial:** `TODO`  
**Dependencias:** `W4-COMI-02`  
**Casos de uso:** `COMI-007`
...
Analizar rendimiento según políticas/incentivos.

## Casos de uso incluidos

| ID | Caso | Actor | Qué debe resolver | Superficie | Servicio(s) | Entidades/objetos | Evento(s) |
|---|---|---|---|---|---|---|---|
| `COMI-007` | **Consultar rendimiento por incentivos** | Manager | Analizar conversión/producción bajo distintas políticas sin confundir correlación con causalidad. | CRM Web | analytics-copilot-service | MetricObservation | — |

## Ownership

- **Servicios propietarios:** `analytics-copilot-service`.
