# W5-RNT-06 — Resolver lifecycle contractual, venta con locación y export contable

- **Ola:** 5 — Operación e integraciones
- **Estado:** `TODO`
- **Dependencias:** `W5-RNT-05`
- **UCs:** `RNT-017`, `RNT-018`, `RNT-019`, `RNT-020`
- **Owner:** `rental-service`, `supply-service`, `closing-service`.
...
## Resultado
Resolver lifecycle contractual, venta con locación y export contable.
