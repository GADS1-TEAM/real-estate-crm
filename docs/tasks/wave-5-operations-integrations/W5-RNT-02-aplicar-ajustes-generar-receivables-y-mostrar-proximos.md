# W5-RNT-02 — Aplicar ajustes, generar receivables y mostrar próximos hitos

- **Ola:** 5 — Operación e integraciones
- **Estado:** `TODO`
- **Dependencias:** `W5-RNT-01`
- **UCs:** `RNT-005`, `RNT-006`, `RNT-016`
...
## Resultado
Aplicar ajustes, generar receivables y mostrar próximos hitos.
