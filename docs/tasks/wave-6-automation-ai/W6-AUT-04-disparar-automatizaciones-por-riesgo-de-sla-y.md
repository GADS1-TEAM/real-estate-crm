# W6-AUT-04 — Disparar automatizaciones por riesgo de SLA y cambios de matching

- **Ola:** 6 — Automatización e inteligencia
- **Estado:** `TODO`
- **Dependencias:** `W5-INT-04`, `W2-MAT-03`
- **UCs:** `AUT-009`, `AUT-010`
- **Owner:** `automation-ai-service`, `notification-service`, `matching-service`.
...
## Resultado
Disparar automatizaciones por riesgo de SLA y cambios de matching.
