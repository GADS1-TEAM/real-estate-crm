...
// Validación en el borde con forma de respuesta estable: un [Required]/[MaxLength] roto nunca
// sale con el ValidationProblemDetails por defecto, sale como ProblemDetailsV1.
...
// D2/D7: party-service consume access-service (permisos, validación de responsable, usuario del
// actor) y platform-config-service (catálogos) por HTTP, con caché corta.
