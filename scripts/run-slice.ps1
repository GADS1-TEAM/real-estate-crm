...
Start-Process dotnet -ArgumentList "run --project services/commercial-service/src/CommercialService.Api/CommercialService.Api.csproj --urls http://localhost:5145"
Start-Process dotnet -ArgumentList "run --project services/activity-service/src/ActivityService.Api/ActivityService.Api.csproj --urls http://localhost:5247"

Start-Process dotnet -ArgumentList "run --project services/analytics-service/src/AnalyticsService.Api/AnalyticsService.Api.csproj --urls http://localhost:5046"
Start-Process dotnet -ArgumentList "run --project services/automation-ai-service/src/AutomationAiService.Api/AutomationAiService.Api.csproj --urls http://localhost:5015"
